...
The check of code above was originally in a new column and was checked dependently before directly editing the ride_length

Another incomprehensible inconsistency noticed is the bikes returned before being used.

In order to work on a cleaner dataframe, I decided to split the ride_length into two dataframes:
...
The file imported had some issues with data type, I was forced to convert them to the correct ones. The data manipulation made is as follows:
...
# Already done above, but in order to make things like before. I preferred the rerun it.
